...
for i in range(video_paths.shape[0]):
    ...
    if pd.isnull(INPUT_VIDEO) is False:
        ...
        OUTPUT_FILE = "code/02-analysis_audio/audio/" + relative_path_for_audio
