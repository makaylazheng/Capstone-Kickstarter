...
model_path = root + "/pyAudioAnalysis_model"
pyAudioAnalysisModel = model_path + '/svmSpeechEmotion'
audios = os.listdir(audio_root)

scr = pd.read_csv("code/data/video_paths.csv" ,index_col=0)
audio_result_df = df()
...
root = "code"
audio_root = root + "/data/audio"
model_path = root + "/speechemotionrecognition_model"
...
audio_result_df.to_csv("code/data/analysis_audio_results.csv"
                       , float_format="%.2f")
